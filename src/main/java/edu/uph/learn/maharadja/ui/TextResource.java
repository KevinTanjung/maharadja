...
public class TextResource {
  ...
  public static final String ATTACK_TARGET_TERRITORY_LABEL = "Select attack target:";
  public static final String ATTACK_NUM_OF_TROOPS_LABEL = "# of Attacking Troops:";
  public static final String FORTIFY_TITLE = "Fortify a Territory!";
  public static final String FORTIFY_ACTION = "FORTIFY";
